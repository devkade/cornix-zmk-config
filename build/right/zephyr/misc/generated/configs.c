...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_COMBO_MAX_PRESSED_COMBOS, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_COMBO_MAX_COMBOS_PER_KEY, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_COMBO_MAX_KEYS_PER_COMBO, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_KSCAN_DEBOUNCE_PRESS_MS, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_KSCAN_DEBOUNCE_RELEASE_MS, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_CORNIX_CHARGER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_SOFT_OFF_WAKEUP_SOURCES_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_CORNIX_RIGHT, 1);
